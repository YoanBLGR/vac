  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        type: "boat",
        detail: "Deux belles options selon l’énergie du jour : partir explorer les criques en bateau privé ou prolonger la récupération au bord d’une piscine rooftop.",
        tips: [
          "Option A recommandée pour continuer à découvrir",
          "Option B idéale si la fatigue commence à s’accumuler",
          "Confirmer l’option choisie avant le séjour",
        ],
        options: [
          {
            name: "Speedboat privé",
            note: "Notre choix · 1 h 30 entre Kep Merli, Pigeon Cave, crique calme et îlots de Ksamil",
            url: "https://www.ksamilwatersport.com/",
          },
          {
            name: "Rooftop pool de Porta",
      ...
      },
      {
        ...
        tips: [
          ...
          "Si l’accès est refusé, conserver l’option bateau",
        ],
        location: {
      ...
      {
        time: "17:00",
        title: "Option A · Les criques en privé",
        type: "boat",
        detail: "Sortie de 1 h 30 avec Ksamil Water Sport autour de Kep Merli, Pigeon Cave, d’une crique choisie selon la mer et des îlots de Ksamil.",
        tips: [
          "Rendez-vous vers 16:45 à Ksamil Beach",
          "Demander baignade et snorkeling, sans dépose aux Twin Islands",
          "WhatsApp : +355 69 522 3077",
          "Retour vers 18:30 puis douche à l’hôtel",
        ],
        location: {
      ...
      },
      {
        ...
        type: "sunset",
        detail: "Après le bateau, monter avec une boisson fraîche sur le rooftop de l’Hotel Siars. Avec l’option piscine, rester à Porta pour la lumière dorée.",
        tips: [
